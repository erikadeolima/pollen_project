...
function Sobre() {
    return(
        <div className='mainContainer'>
            ...
            <p>
                Você ganhará pontos semanais no valor de 100 onde poderá acumular e trocar por prêmios no nosso site, através de premiações em treinamentos e atividades. 
            </p>
            <h2 className='tituloSobre'>
